...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/IncumplimientoVF/main/incumplimientovf20152021.csv")
...
mytitle=' '
tabtitle='No asistencia familiar'
    ...
    html.Br(),
        ...
        dbc.Row(
           [
               ...
               dbc.Col(html.P("No asistencia familiar"),
    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "La No asistencia familiar es uno de los delitos más graves de la violencia de género que se vive en el país, "
       ...
       str(TASATRATAPERSONAS) +" delitos por cada 100 mil habitantes. "+
                    ...
                    "Este tablero analítico se compone de una sección en la cual tratamos la No asistencia familiar, observamos "
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de no asistencia familiar" ),
     ...
     dbc.Row(
           [
               ...
               dbc.Col(dbc.Button(([html.H5("2022", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2022.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
