...
tabla1_f = tabla1[tabla1['Tipo de delito']== 'No asistencia familiar' ]
...
delitos = pd.read_csv("https://raw.githubusercontent.com/fdealbam/IncumplimientoVF/main/incumplimientovf2015_2021.csv")
...
# Cintillo 000
   ...
   dbc.Row([
    ...
    html.Br(),
        ...
        dbc.Row(
           [
               dbc.Col(html.P("Incumplimiento de obligaciones de asistencia familiar"),
    ...
    dbc.Row(
       ...
       dbc.Row(
            [
                ...
                html.P(
                    "El incumplimiento de obligaciones de asistencia familiar es "#Aqui cambia nombre de delito
                  ...
                  " Entre 2015 y 2021 se registraron "+ str(f"{int(TOTINCFAM):,}") +" casos, lo que representa una tasa de "+
       str(TASAINCFAM) +" delitos por cada 100 mil habitantes. "+
                  "Este tablero analítico se compone "
                    " de una sección en la cual tratamos"+
                    "el incumplimiento de obligaciones de asistencia familiar," #Aqui cambia nombre de delito
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.H5("2015", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2015.png?raw=true",
               ...
               dbc.Col(dbc.Button(([html.H5("2016", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2016.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2017", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2017.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2018", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2018.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2019", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2019.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2020", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2020.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
               ...
               dbc.Col(dbc.Button(([html.H5("2021", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/Mapa%20incumplimientovf%20Total2021.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
  ...
  dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P("México", style={"font-size": 30,"color": "black","background-color": "white"}),
                  ...
                  style={'size': 2,}),
                          html.P(
                          "Los diez municipios con más incumplimiento de obligaciones de asistencia familiar fueron: Ecatepec de Morelos (1,720), Toluca (1,584), Cuautitlán Izcalli (823), Atizapán de Zaragoza (704), Nezahualcóyotl (653), Tlalnepantla de Baz (617), Naucalpan de Juárez (605), Texcoco (543), Chalco (435), y Nicolás Romero (423).",
               ...
               dbc.Col(dbc.Button(([html.P("Sonora", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/sonora.png?raw=true",
                                    style={'size': 2,}),
                       html.P(
                           "Los diez municipios con más incumplimiento de obligaciones de asistencia familiar fueron: Hermosillo (6,518), Cajeme (1,772), Nogales (683), Agua Prieta (654), Navojoa (584), San Luis Río Colorado (399), Guaymas (366), Caborca (339), Puerto Peñasco (331), y Etchojoa (308).",
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
    ...
    html.Br(),
          ...
          dbc.Col(dbc.Button(([html.P("Tamaulipas", style={"font-size": 30,"color": "black","background-color": "white"}),
                       ...
                       html.P(
                           "Los diez municipios con más incumplimiento de obligaciones de asistencia familiar fueron: Victoria (2,846), Matamoros (2,692), Reynosa (1,408), Nuevo Laredo (880), Altamira (823), Tampico (790), Río Bravo (569), El Mante (511), Ciudad Madero (489), y San Fernando (255).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                         'margin-left': '300px',
               ...
               dbc.Col(dbc.Button(([html.P("Chihuahua", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/IncumplimientoVF/blob/main/application/static/chch.png?raw=true"),
                        ...
                        html.P(
                          "Los diez municipios con más incumplimiento de obligaciones de asistencia familiar fueron: Chihuahua (5,807), Juárez (1,303), Delicias (1,268), Meoqui (527), Hidalgo del Parral (504), Cuauhtémoc (490), Camargo (213), Nuevo Casas Grandes (201), Jiménez (172), y Rosales (134).",
                           style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
